...
public class ProfileStore {
    ...
    private static void writeProfile(PersistedObject o, OAuthProfile p) {
        ...
        o.setString("jwtAlgorithm",      p.getJwtAlgorithm() != null ? p.getJwtAlgorithm().name() : OAuthProfile.JwtAlgorithm.RS256.name());
        o.setString("jwtAudience",       p.getJwtAudience());
        o.setInteger("jwtLifetime",      p.getJwtLifetimeSeconds());
        o.setString("ropcUsername",      p.getRopcUsername());
        o.setString("ropcPassword",      p.getRopcPassword());
        ...
        o.setBoolean("injectSequencer",  p.isInjectSequencer());
        o.setBoolean("injectTarget",     p.isInjectTarget());
        o.setBoolean("injectionEnabled", p.isInjectionEnabled());
        o.setString("httpVersion",       p.getHttpVersion());
    ...
    private static OAuthProfile readProfile(String name, PersistedObject o) {
        ...
        safeStr(o.getString("ropcUsername"),      p::setRopcUsername);
        safeStr(o.getString("ropcPassword"),      p::setRopcPassword);
        ...
        safeBool(o.getBoolean("injectSequencer"),  p::setInjectSequencer);
        safeBool(o.getBoolean("injectTarget"),     p::setInjectTarget);
        safeBool(o.getBoolean("injectionEnabled"), p::setInjectionEnabled);
        safeStr(o.getString("httpVersion"),        p::setHttpVersion);
